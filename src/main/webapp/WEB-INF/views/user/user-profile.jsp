...
<header class="header--form-page" style="text-align: center">
    ...
    <div class="container container--90 user-info-d-visible" style="padding-top: 65px">
        <h2><spring:message code="app.user-profile-info-h2"/></h2>
        <div class="form-group">
            <c:if test="${param.userUpdate == 'success'}">
                <p style="color: #08b910; font-size: 16px">
                    <spring:message code="app.user-profile-edit-success-msg"/>
                </p>
            </c:if>
        </div>
        <div class="form-group">
            <input class="user-info-input" type="text" readonly value="${user.email}">
            <input class="user-info-input" type="text" readonly value="${user.name}">
            <input class="user-info-input" type="text" readonly value="${user.surname}">
        </div>
        <div class="form-group form-group--buttons" style="margin-top: 50px; margin-bottom: 50px">
            <button class="btn edit-profile-btn" type="submit">
                <spring:message code="app.user-profile-edit-profile-btn"/>
            </button>
        </div>
    </div>

    <div class="container container--90 user-info-d-none" style="padding-top: 65px">
        <h2><spring:message code="app.user-profile-edit-h2"/></h2>

        <form:form id="user-profile-form" modelAttribute="updateUser">
            <form:hidden path="id"/>
            <form:hidden path="roles"/>
            <form:hidden path="enabled"/>
            <div class="form-group">
                <spring:message code="app.registration-email-ph" var="name_ph"/>
                <form:input path="email" type="email" class="update-user-email form-control form-control-user" placeholder='${name_ph}'/>
            ...
            <div class="form-group">
                ...
                <form:input path="name" type="text" class="update-user-name form-control form-control-user"  placeholder='${name_ph}'/>
            ...
            <div class="form-group">
                ...
                <form:input path="surname" type="text" class="update-user-surname form-control form-control-user" placeholder='${surname_ph}'/>
            ...
            <div class="form-group">
                ...
                <form:input path="password" type="password" class="update-user-password" placeholder='${password_ph}'/>
            ...
            <div class="edit-profile-btn-div" >
                ...
                <button style="float: right" class="btn save-profile-changes-btn hidden" type="button">
