...
<header class="header--form-page">
    ...
    <div class="slogan container container--90">
        <div class="slogan--item">
            <h2>
                <c:if test="${param.submitDonation == 'failed'}">
                    <p style="color: red; font-size: 16px">
                        <spring:message code="app.donation-form-submit-failed"/>
                    </p>
                </c:if>
                <spring:message code="app.donation-form-page-heading-h1"/><br/>
                <span class="uppercase">
                    <spring:message code="app.donation-form-page-heading-h1-span"/>
                </span>
            </h2>

            <div class="slogan--steps">
                <div class="slogan--steps-title"><spring:message code="app.donation-form-slogan-heading"/></div>
                <ul class="slogan--steps-boxes">
                    <li>
                        <div>
                            <em>1</em><span><spring:message code="app.donation-form-slogan-heading-span-1"/></span>
                        </div>
                    </li>
                    <li>
                        <div>
                            <em>2</em><span><spring:message code="app.donation-form-slogan-heading-span-2"/></span>
                        </div>
                    </li>
                    <li>
                        <div>
                            <em>3</em><span><spring:message code="app.donation-form-slogan-heading-span-3"/></span>
                        </div>
                    </li>
                    <li>
                        <div>
                            <em>4</em><span><spring:message code="app.donation-form-slogan-heading-span-4"/></span>
                        </div>
                    </li>
                </ul>
            </div>
...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        <div class="form--steps-counter"><spring:message code="app.donation-form-step-counter-text"/> <span>1</span>/4</div>

        <!-- STEP 1: class .active is switching steps -->
        <form:form class="donation-form" modelAttribute="newDonation" method="post">
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--buttons" style="height: 50px">
                    ...
                    <button type="button" class="btn next-step hidden second-next-step-btn">
                        <spring:message code="app.donation-form-next-step-btn"/>
                    </button>
                </div>
            </div>
            ...
            <div data-step="3">
                ...
                <div class="form-group form-group--buttons">
                    ...
                    <button type="button" class="btn next-step hidden third-next-step-btn">
                        <spring:message code="app.donation-form-next-step-btn"/>
                    </button>
                </div>
            </div>
